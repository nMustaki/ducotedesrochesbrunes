...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        the_5_max = timezone.localtime().replace(year=2021, month=6, day=5, hour=19, minute=0, second=0, microsecond=0)
        ...
        the_6_max = timezone.localtime().replace(year=2021, month=6, day=6, hour=19, minute=0, second=0, microsecond=0)
